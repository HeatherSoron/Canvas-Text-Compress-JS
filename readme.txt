...
This software is available under the CC0 license - basically, public domain. Feel free to treat it as such. It was coded by an anonymous author who prefers not to be named, working with Ethan Kaminski on the project Land of Seylia (a game that can be found on IndieDB). Contact Ethan at <ethan.kaminski@gmail.com> with questions, although hopefully things are, for the most part, documented well enough to be self-explanatory (in line with the first of Larry Wall's virtues of the programmer, laziness).
